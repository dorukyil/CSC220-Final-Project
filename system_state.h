...
typedef struct {
    ...
    /* Condition: any subsystem state has changed            */
    /* Signaled by Engine, Motion, Fuel after updating state */
    /* ECU waits on this instead of busy-polling             */
    pthread_mutex_t state_changed_lock;
